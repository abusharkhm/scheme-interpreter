...
(begin (display 'nineteen) (cdr '(83 84)))
; expect nineteen(84)

(define a (begin (display 3)))
; expect 3a
...
(define (multiply-all-terms n) (*(*(* (* n (* 2 n)) 4) 6) 8))
; expect multiply-all-terms
...
(cond
((= 1 2) (/ 1 0))
((> 3 2) (quote win-the-game-or-know-the-reason-why!))
(else (quote stanford))
)
; expect win-the-game-or-know-the-reason-why!
